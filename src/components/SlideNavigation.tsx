...
const SlideNavigation: React.FC<SlideNavigationProps> = ({
  ...
  return (
    <>
      {/* Enhanced Footer Navigation - Portaled to ensure it appears above modals */}
      {createPortal(
        <div className="fixed bottom-0 left-0 right-0 z-[70] pb-safe">
          {/* Progress Bar */}
      ...
      {/* Slide Overview Modal - Portaled to ensure it appears above everything */}
      {showOverview && createPortal(
        <div className="fixed inset-0 z-[80] bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowOverview(false)}>
      ...
      {/* Swipe Indicators (Mobile) - Portaled to ensure they appear above modals */}
      {createPortal(
        <>
          <div className="sm:hidden fixed left-4 top-1/2 -translate-y-1/2 z-[65] opacity-50">
            {previousRoute && (
          ...
          <div className="sm:hidden fixed right-4 top-1/2 -translate-y-1/2 z-[65] opacity-50">
            {nextRoute && (
              <div className="text-white/60 text-xs flex items-center gap-1 animate-pulse">
                <span>Swipe</span>

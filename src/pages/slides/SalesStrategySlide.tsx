  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-4 sm:top-8 right-4 sm:right-8 z-10 text-right">
        <div className="text-gray-900 text-lg sm:text-xl lg:text-2xl font-space font-bold mb-1 sm:mb-2">ROOTS</div>
        <div className="text-gray-700 text-xs sm:text-sm font-inter mb-1 sm:mb-2">Community Health</div>
        <div className="text-gray-900 text-base sm:text-lg lg:text-xl font-space font-bold">08</div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 pb-20 sm:pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in" style={{ animationDelay: '0.5s' }}>
          ...
          {slideContent?.sections?.[0] && (
            <Card className="bg-gray-100 backdrop-blur-sm p-8 border border-gray-300 hover:bg-gray-200 transition-all duration-300 hover:scale-105">
              <div className="flex items-center gap-4 mb-6">
                <div className="p-3 rounded-full bg-gray-300">
                  <Activity className="w-8 h-8 text-gray-900" />
                </div>
                <div>
                  <div className="text-2xl font-bold text-gray-900 font-space">{slideContent.sections[0].title}</div>
                </div>
              </div>
          ...
          {slideContent?.sections?.[1] && (
            <Card className="bg-gray-100 backdrop-blur-sm p-8 border border-gray-300 hover:bg-gray-200 transition-all duration-300 hover:scale-105">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900 font-space">{slideContent.sections[1].title}</div>
                </div>
              </div>
              <ul className="space-y-3 text-gray-700 font-inter">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in" style={{ animationDelay: '1s' }}>
          <div className="text-center">
            <div className="p-4 rounded-full bg-gray-300 mx-auto mb-4 w-fit">
              <Heart className="w-8 h-8 text-gray-900" />
            </div>
            <div className="text-xl font-bold text-gray-900 mb-2 font-space">Heart Health</div>
            <div className="text-gray-700 text-sm font-inter">Cardiovascular benefits</div>
          </div>
          <div className="text-center">
            <div className="p-4 rounded-full bg-gray-300 mx-auto mb-4 w-fit">
              <Users className="w-8 h-8 text-gray-900" />
            </div>
            <div className="text-xl font-bold text-gray-900 mb-2 font-space">Community</div>
            <div className="text-gray-700 text-sm font-inter">Social connections</div>
          </div>
          <div className="text-center">
            <div className="p-4 rounded-full bg-gray-300 mx-auto mb-4 w-fit">
              <Activity className="w-8 h-8 text-gray-900" />
            </div>
            <div className="text-xl font-bold text-gray-900 mb-2 font-space">All Levels</div>
            <div className="text-gray-700 text-sm font-inter">Beginner friendly</div>
          </div>
        </div>
      </div>

      {/* Bottom Tagline */}
      <div className="absolute bottom-16 left-8 text-gray-700 font-space font-medium animate-fade-in" style={{ animationDelay: '1.5s' }}>
        MOVE. CONNECT. THRIVE.
      </div>
